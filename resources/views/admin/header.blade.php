<div class="container-fluid page-body-wrapper">
    ...
    <nav class="navbar p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="{{ url('/') }}"><img src="/admin/assets/images/logo-mini2.png" alt="logo" /></a>
        </div>
            ...
            <ul class="navbar-nav w-100">
                <li class="nav-item w-100">
                    <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" action="{{ url('search_product') }}" method="GET">
                        <input type="text" class="form-control" name="search" placeholder="Search by product title or category">
                    </form>
                </li>
            </ul>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                        ...
                        <div class="dropdown-item preview-item">
                            ...
                            <div class="preview-item-content">
                                <a href="{{ url('/user/profile') }}" class="preview-subject mb-1 settings">Settings</a>
                            </div>
                        </div>
                        <div class="dropdown-divider"></div>
                        <div class="dropdown-item preview-item">
                            ...
                            <div class="preview-item-content">
                                <a href="{{ url('logout') }}" class="preview-subject mb-1 logout">Log out</a>
                            </div>
                        </div>
                    </div>
                </li>
